...
const filterTodos = (filterValue) => {
    ...
    switch (filterValue) {
        ...
        case "done":
            ...
            break
        case "todo":
            todos.forEach((todo) => todo.classList.contains("todo") ? (todo.style.display = "flex") : (todo.style.display = "none")
            )
            break
        default:
            break
...
document.addEventListener("click", (e) => {
    ...
    if (targetEl.classList.contains("finish-todo")) {
        ...
        updateTodoStatusLocalStore(todoTitle)
...
const saveTodoLocalStorage = (todo) => {
    ...
    // Todos od todo's da LocalStorage
    const todos = getTodosLocalStorage()

    // Adicionar o novo todo da array
    todos.push(todo)

    // Salvar tudo nas LocalStorage
...
const updateTodoStatusLocalStore = (todoText) => {
